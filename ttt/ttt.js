...
(function (root) {
  ...
  var Game = TTT.Game = function TT($rootEl) {
  ...
  Game.prototype.setUpEvents = function() {
    var game = this;
    this.$el.click('.square', game.move.bind(game));
  };
  ...
  Game.prototype.move = function ($square) {
    ...
    //var pos = [$square.attr("data-row"). $square.attr("data-col")];
    ...
    if (game.winner()) {
      $("#winner").html("Someone died! Sorry bro.");
    };
    return true;
  };
